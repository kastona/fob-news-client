...
export default function (ctx, inject) {
  ...
  // Register strategies
  // local
  $auth.registerStrategy('local', new scheme_003d9a64($auth, {"endpoints":{"login":{"url":"/users/login","method":"post","propertyName":"token"},"logout":{"url":"/users/logout","method":"post"},"user":{"url":"/users/me","method":"get","propertyName":"user"}},"_name":"local"}))
